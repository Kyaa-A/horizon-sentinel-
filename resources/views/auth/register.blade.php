<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" x-data="{ role: '{{ old('role', 'employee') }}' }">
        @csrf
        ...
        <div class="mt-4" x-show="role === 'employee'">
            <x-input-label for="manager_id" :value="__('Select Your Manager')" />
